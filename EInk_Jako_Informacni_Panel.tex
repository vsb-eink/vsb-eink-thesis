...
\label{appendix:facade-api-client}
...
\label{appendix:app-screenshots}
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{Obrazky/aplikace/eink.a1314.cz_hosted.png}
    \caption{Obrazovka seznamu uživatelských souborů}
    \label{fig:hosted-view}
\end{figure}
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{Obrazky/aplikace/eink.a1314.cz_login.png}
    \caption{Obrazovka přihlášení}
    \label{fig:login-view}
\end{figure}
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{Obrazky/aplikace/eink.a1314.cz_schedule.png}
    \caption{Obrazovka detailu plánovaného úkolu}
    \label{fig:schedule-view}
\end{figure}
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{Obrazky/aplikace/eink.a1314.cz_usergroup.png}
